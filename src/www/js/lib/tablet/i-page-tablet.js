...
//						u.bug("get scene:" + ".scene."+node._org_node.className + ", " + node._scene)
					}
...
//				u.bug("cN.navigate:" + url + ", " + page.navigating + ", " + page.scenes)
...
//							u.bug("navigation transition to:" + u.nodeId(node) + ", " + node._i + ", " + page._distance);
...
//				u.bug("rePositionAfterNavigation")
...
//					u.bug("page.current_scene:" + u.nodeId(page.current_scene));
//					for(classname in page.intro.preloads) {
//						if(u.hc(page.current_scene, classname)) {
//							u.preloader(this, page.intro.preloads[classname]);
//						}
//					}
				}
